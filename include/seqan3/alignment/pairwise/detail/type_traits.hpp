...
public:
    ...
    static constexpr bool has_output_configuration = compute_score || compute_end_positions ||
                                                     compute_begin_positions || compute_sequence_alignment ||
                                                     output_sequence1_id || output_sequence2_id;
