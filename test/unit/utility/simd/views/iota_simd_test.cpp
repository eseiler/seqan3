...
TEST(iota_simd_test, combinability)
{
    ...
    auto simd_iota_take_transform_view =
        seqan3::views::iota_simd<simd_t>(0, 10) | std::views::take(3) |
        std::views::transform([](auto const simd_value) { return simd_value + seqan3::simd::fill<simd_t>(3); });
